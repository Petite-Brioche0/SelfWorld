...
ALTER TABLE zones
  ADD COLUMN IF NOT EXISTS ask_join_mode TINYINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS ask_approver_mode TINYINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS profile_title VARCHAR(255) NULL,
  ADD COLUMN IF NOT EXISTS profile_desc TEXT NULL,
  ADD COLUMN IF NOT EXISTS profile_tags TEXT NULL;
