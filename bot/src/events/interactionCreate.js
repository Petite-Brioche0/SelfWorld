// Ensures interactions are validated, checking permissions and cooldowns
...
module.exports = {
        ...
        async execute(interaction, client) {
                ...
                try {
                        ...
                        await safeReply(interaction, {
                                content: '❌ **Erreur**\n\nUne erreur s\'est produite lors du traitement de ta requête. Réessaye dans quelques instants.',
                                flags: MessageFlags.Ephemeral
                        });
                } finally {
